    ...
    <section className="p-2 md:p-5 bg-gray-50">
        <form className="form py-3 p-4 md:p-8 bg-white shadow-sm rounded-md" onSubmit={handleSubmit}>
            <div className="scroll max-h-[70vh] md:max-h-[72vh] overflow-y-auto pr-2 md:pr-4 pt-4">
                ...
                {/* Systematic Title and Description */}
                <div className="flex flex-col mb-3">
                    ...
                    <div className="w-full mt-5">
                        ...
                        <div className="border border-gray-200 rounded-sm overflow-hidden">
                            <Editor
                                containerProps={{ style: { resize: 'vertical', minHeight: '200px' } }}
                                value={html} 
                ...
                <br />
                <h3 className="text-[15px] md:text-[16px] font-[500] mb-3 text-black border-b pb-2">Blog Image</h3>
                
                {/* Adaptive Image Grid: 2 columns on mobile, up to 7 on desktop */}
            ...
            <br />
            {/* Responsive Submit Button: Full width on mobile, 250px on larger screens */}
